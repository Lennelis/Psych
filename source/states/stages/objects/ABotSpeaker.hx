...
class ABotSpeaker extends FlxSpriteGroup
{
	...
	public function initAnalyzer()
	{
		...
		// so we shrink the transform by hand. This has to be `sys`, not `desktop` - Android is native too,
		// and it was quietly running the library's default (much larger) FFT every single frame.
		analyzer.fftN = 256;
		#end
	}
	#end
